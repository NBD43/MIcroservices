...
//	}
	...
	public ResponseEntity<Response>CollaboratorAdd(@RequestHeader String token,@RequestParam Long noteId,@RequestParam String emailId){
		//logger.info(notesDto.toString());
		Response responseStatus=noteService.addCollaborator(token, emailId, noteId);
		return new ResponseEntity<Response>(responseStatus,HttpStatus.OK);
	}
	
	@DeleteMapping("/removecollaborator")
	public ResponseEntity<Response>CollaboratorRemove(@RequestHeader String token,@RequestParam Long noteId,@RequestParam String emailId){
		//logger.info(notesDto.toString());
		Response responseStatus=noteService.removeCollaborator(token, emailId, noteId);
		return new ResponseEntity<Response>(responseStatus,HttpStatus.OK);
	}
//	
